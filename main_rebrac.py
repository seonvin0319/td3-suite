...
if __name__ == "__main__":
    ...
    # ---------------- Initialize policy ----------------
    if args.policy == "ReBRAC":
        from agent import ReBRAC
        policy = ReBRAC(**kwargs)

    elif args.policy == "POGO_W":
        from agent_pogo_w import POGO_W
        policy = POGO_W(
            state_dim=state_dim,
            action_dim=action_dim,
            max_action=max_action,
        ...
        from agent_pogo_fr import POGO_FR
        policy = POGO_FR(
            state_dim=state_dim,
            action_dim=action_dim,
            max_action=max_action,
